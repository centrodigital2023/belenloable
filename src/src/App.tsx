    ...
    <BrowserRouter>
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          {/* Legal pages - matching sitemap URLs */}
          <Route path="/terminos-y-condiciones" element={<TerminosYCondiciones />} />
          <Route path="/politica-de-privacidad" element={<PoliticaPrivacidad />} />
          <Route path="/legales/terminos-y-condiciones" element={<TerminosYCondiciones />} />
          <Route path="/legales/politica-privacidad-datos" element={<PoliticaPrivacidad />} />
